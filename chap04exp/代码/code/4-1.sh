...
Attention:
    ...
    image file.And the result wiil be stored in the ImgOutPut dir.
EOF
}
...
prefix="" 
suffix="" 
if_convert=0 #judge if convert
dir="" #input filename
out="ImgOutPut" #output filename
# Jpg compress
...
while true;do
    case "$1" in
        ...
        -w|watermark)# must have parameter
